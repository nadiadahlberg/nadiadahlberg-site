...
<section class="pt-6">
    <h4 class="text-lg font-semibold">
        ...
        <div class="pt-7">
        <h3 class="underline font-bold text-md mb-1">Bachelor’s Degree in Media and Communication Science</h3>
    </div> 
    ...
    <ul class="list-disc pl-5 mt-2 text-sm font-thin">
        <li>Exchange semester: University of Canberra, Australia</li>
            ...
            <div class="pt-7">
        <h3 class="underline font-bold text-md pb-0">Game Programming</h3>
    </div>
